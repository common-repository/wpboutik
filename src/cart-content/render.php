                ...
                <div class="relative ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                    <div>
                        <div class="flex justify-between sm:grid sm:grid-cols-2">
                            ...
                            <p class="text-right text-sm font-medium text-gray-900"><?php echo __( 'Unit price', 'wpboutik' ) . ( $activate_tax ? ' HT' : '' ) . ' : ' . esc_html( wpboutik_format_number( $price + $selling_fees ) . $currency_symbol ); ?></p>
                        </div>
